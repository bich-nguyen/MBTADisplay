  ...
  async fetch(request, env2) {
    ...
    if (url.pathname.startsWith("/api/")) {
      ...
      if (url.pathname.startsWith("/api/weather")) {
        ...
        return proxyRequest(apiUrl, {
          headers: {
            "User-Agent": `MBTADashboard/1.0 (${env2.WEATHER_CONTACT})`,
    ...
    if (url.pathname === "/") {
      return env2.ASSETS.fetch(new Request("/index.html", request));
    }
...
// .wrangler/tmp/bundle-AKucon/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-AKucon/middleware-loader.entry.ts
